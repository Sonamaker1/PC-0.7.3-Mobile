function onCreate()
addCharacterToList('minnie', 'dad')
addCharacterToList('pete', 'dad')
end
...
setProperty('dad.x', defaultOpponentX - 610 + 70)
...
elseif dadName == 'minnie' then
setProperty('dad.y', getProperty('bg6.y') + 220)
elseif dadName == 'pete' then--different Y(s) for all 3 opponents
